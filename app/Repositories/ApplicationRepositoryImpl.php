...
class ApplicationRepositoryImpl extends AbstractRepositoryImpl implements ApplicationRepository {
    ...
    public function __construct(Controller $controllors, ApplicationDocumentFileRepository $appDocFileRepo,
                                ApplicationPeopleRefRepository $appPeopleRefRepo) {
    ...
    public function getApplicationAndProgramInfoByApplicationId($applicationId)
    {
        try {
            $query = DB::table('application as app')
                ->select('app.application_id', 'app.flow_id',
                    'flow_app.flow_name', 'flow_app.flow_name_en',
                    'curr_prog.curr_prog_id', 'curr_prog.program_id', 'curr_prog.program_type_id',
                    'mc.thai as prog_name', 'mc.english as prog_name_en', 'mc.plan',
                    'progt.prog_type_name', 'progt.office_time'
                )
