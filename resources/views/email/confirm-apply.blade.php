...
คุณได้สมัครหลักสูตร {{ $thai.'['.$coursecodeno.']'}} แขนงวิชา {{$sub_major_name}} [{{$sub_major_id}}]  สาขาวิชา{{$major_name}}[{{$major_id}}]  ภาควิชา {{$department_name}} [{{$department_id}}]  {{$faculty_name}} ประจำภาคการศึกษา {{$semester}} ปีการศึกษา {{$year}}

เรียบร้อยแล้ว

<br/>โปรดดำเนินการ Uplod เอกสารประกอบการสมัคร
<br/>และ/หรือ ชำระค่าธรรมเนียมการสมัคร และจัดส่งหลักฐานการชำระค่าธรรมเนียมและใบปะหน้าซอง ที่บัณฑิตวิทยาลัย
<br/>
