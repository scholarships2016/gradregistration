                        ...
                        <div class="portlet light bordered">
                          <div class="portlet-title">
                            ...
                            <div class="portlet-body form">
                                <div class="form-body">
                                  <form action="{!! Route('postNews') !!}" id="form_sample_1" class="form-horizontal" method='post' novalidate="novalidate">
                                      ...
                                      <div class="form-body">
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-md-4">
                                                      <input type="text" readonly name="news_id" value="{{$news_id}}"  class="form-control" placeholder=""> </div>
                                              </div>
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-md-9">
                                                      <input type="text" name="news_title" value="{{$news_title}}" data-required="1" class="form-control"> </div>
                                              </div>
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-md-9">
                                                    <textarea class="ckeditor form-control" data-required="1" name="news_detail" rows="6" data-error-container="#editor1_error">{{$news_detail}}</textarea>
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-md-9">
                                                      <input type="text" name="news_title_en" value="{{$news_title_en}}" data-required="1" class="form-control"> </div>
                                              </div>
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-md-9">
                                                    <textarea class="ckeditor form-control" name="news_detail_en" rows="6" data-error-container="#editor2_error">{{$news_detail_en}}</textarea>
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-md-4">
                                                    <select class="form-control" name="news_seq">
                                                        @for ($i = 0; $i < 20; $i++)
                                                            <option {{($news_seq == ($i+1))?'selected':''}} value="{{$i+1}}">{{$i+1}}</option>
                                                        @endfor
                                                  ...
                                                  <div class="col-md-4">
                                                    <div class="mt-radio-inline" data-error-container="#form_2_membership_error">
                                                            <label class="mt-radio">
                                                                <input type="radio" name="news_is_active" value="1" {{($news_is_active  == 1)?'checked':''}} > Yes
                                                                <span></span>
                                                            </label>
                                                            <label class="mt-radio">
                                                                <input type="radio" name="news_is_active" value="0" {{($news_is_active  == 0)?'checked':''}}> No
                                                                <span></span>
                                                            </label>
