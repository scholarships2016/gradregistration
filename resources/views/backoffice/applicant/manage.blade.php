                ...
                "columnDefs": [
                    {
                        ...
                        render: function (data, type, full, meta) {
                            return full.rownum + '' + ((user_role == "Admin" && isNaN(full.creator + 0) === true ) || user_name == full.creator ? '<br/><i class="fa fa-pencil font-yellow" title="เพิ่มข้อมูลโดยเจ้าหน้าที่: ' + full.creator + ' สามารถแก้ไขได้"></i>' : '');
                        }
                    },
                    {
                        targets: 1,
