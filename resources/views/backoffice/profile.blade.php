    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject bold uppercase">ข้อมูลส่วนตัว</span>
            </div>
            <div class="actions">
                            ...
                            <div class="mt-radio-list" data-error-container="#form_2_membership_error">
                                <label class="mt-radio">
                                    <input type="radio" name="role_id" value="1"
                                           @if(!empty($user)&&$user->role_id == 1) checked @endif disabled>
                                    Administrator
                                    <span></span>
                                </label>
                                <label class="mt-radio">
                                    <input type="radio" name="role_id" value="2"
                                           @if(!empty($user)&&$user->role_id == 2) checked
                                           @endif disabled> เจ้าหน้าที่บัณฑิต
                                    <span></span>
                                </label>
                                <label class="mt-radio">
                                    <input type="radio" name="role_id" value="3"
                                           @if(!empty($user)&&$user->role_id == 3) checked
                                           @endif disabled>
                ...
                <div class="form-actions">
                    <div class="row">
                        <div class="col-md-offset-3 col-md-9">
                            <a href="/admin/setting/adminManage/manage">
