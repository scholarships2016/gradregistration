...
@section('pagebar')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="#">รายงานคะแนนภาษาอังกฤษของผู้มีสิทธิ์เข้าศึกษา</a>
                <i class="fa fa-circle"></i>
            </li>
        </ul>
    </div>
                ...
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase">
                            รายงานคะแนนภาษาอังกฤษของผู้มีสิทธิ์เข้าศึกษา
                        </span>
                    </div>
                    <div class="actions">
                ...
                <div class="portlet-body">
                    ...
                    <div class="table-container">
                        ...
                        <div class="portlet box pink-chula">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="icon-bar-chart"></i>รายงานคะแนนภาษาอังกฤษของผู้มีสิทธิ์เข้าศึกษา
                                </div>
                                <div class="tools">
...
<script type="application/javascript">
    ...
    function exportToFile(e) {
        var url = '{{route('admin.report.doReport09Excel')}}?';
    ...
    $(document).ready(function () {
        ...
        $("#reportBt").on('click', function () {
            ...
            $.ajax({
                url: '{{route('admin.report.doReport09')}}',
                method: "get",
                data: inputs,
