...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span>รายงานผู้สมัครเข้าศึกษาที่สนใจรับทุน</span>
        </li>
    </ul>
    {{--
...
<h1 class="page-title">รายงานผู้สมัครเข้าศึกษาที่สนใจรับทุน
                        ...
                        <div>
                            ...
                            <div class="portlet box pink-chula">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-bar-chart"></i>รายงานผู้สมัครเข้าศึกษาที่สนใจรับทุน </div>
                                    <div class="tools">
