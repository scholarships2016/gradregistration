...
<script type="application/javascript">
      ...
      window.open(("{{ url('admin/printForeignerReport')}}" +'/'+ $('option:selected','#year').val()+'/'+ $('option:selected','#semester').val()+'/'+ $('option:selected','#roundNo').val()+'/'+ faculty+'/'+ '1,2,3,4,5'+'/'+  sub_major_id +'/'+ $('option:selected','#program_type_id').val()+'/'+ program_id +'/'+ print  ),'_blank');
