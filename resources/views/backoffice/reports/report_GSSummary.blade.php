...
@section('pagebar')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="#">รายงานสรุปยอดผู้สมัครเข้าศึกษา</a>
                <i class="fa fa-circle"></i>
            </li>
        </ul>
    </div>
                ...
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase">
                            รายงานสรุปยอดผู้สมัครเข้าศึกษา
                        </span>
                    </div>
                    <div class="actions">
                ...
                <div class="portlet-body">
                    ...
                    <div class="table-container">
                        ...
                        <div class="portlet box pink-chula">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="icon-bar-chart"></i>รายงานสรุปยอดผู้สมัครเข้าศึกษา
                                </div>
                                <div class="tools">
...
<script type="application/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#reportBt").on('click', function () {
            ...
            $.ajax({
                url: '{{route('admin.report.doReport03')}}',
                method: "get",
                data: inputs,
