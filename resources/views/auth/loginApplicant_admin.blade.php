@extends('layouts.default2') @section('maincontent')
<!-- BEGIN LOGO -->
  ...
  <form class="login-form" action="{{url('/login_admin')}}" method="post">
    ...
    <div class="form-group">
      ...
      <div class="input-icon">
        ...
        <input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="กรอกรหัสผ่าน" id="user_password" name="user_password" /></div>
    </div>
