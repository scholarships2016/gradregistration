        ...
        <form class="login-form" action="{{ url('/login')}}" method="post">
            ...
            <div class="form-group">
                ...
                <div class="input-icon">
                    ...
                    <input class="form-control placeholder-no-fix" pattern="[^ @]*@[^ @]*" type="text"
                           autocomplete="off" placeholder="{{Lang::get('resource.lbLoginEmail')}}"
            ...
            <div class="form-group">
                ...
                <div class="input-icon">
                    ...
                    <input class="form-control placeholder-no-fix" type="password" autocomplete="off"
                           placeholder="{{Lang::get('resource.lbLoginSignupPassword')}}" id="stu_password"
                           name="stu_password"/></div>
            </div>
            <div class="formm-group">
                <div class="g-recaptcha" data-sitekey="6LdTciwUAAAAAIghJhuM4wf8Dnzc-eadlLikCWiR"
            ...
            <div class="forget-password">
                ...
                <p>
                    <button type="button" class="btn btn-circle red-pink btn-outline  "
                            id="forget-password">{{Lang::get('resource.lbLoginForgetPasswordButton')}}</button>
                    {{Lang::get('resource.lbLoginForgetPasswordButtonDesc')}} </p>
            </div>
            <div class="create-account">
                <p> {{Lang::get('resource.lbLoginRegisterToptic')}}&nbsp;

                    <a href="javascript:;" class="btn btn-circle btn-lg red-pink" id="register-btn"><span
                                class="icon-user-follow"> </span> {{Lang::get('resource.lbLoginRegisterButton')}}
        ...
        <form class="register-form" action="{{route('registerApplicant')}}" method="post">
            ...
            <div class="form-group">
                ...
                <div class="input-icon">
                    ...
                    <input class="form-control placeholder-no-fix" type="text"
                           placeholder="{{Lang::get('resource.lbLoginSignupCitizen')}}" id="stu_citizen_card"
                           name="stu_citizen_card"/>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label">{{Lang::get('resource.lbLoginSignupNameTitle')}}</label>
                <select name="name_title_id" id="name_title_id"
                        placeholder="{{Lang::get('resource.lbLoginSignupNameTitle')}}" class="select2 form-control">
            ...
            <div class="form-group">
                ...
                <div class="input-icon">
                    ...
                    <input class="form-control placeholder-no-fix"
                           onkeyup="return this.value = this.value.toUpperCase()" type="text"
                           placeholder="{{Lang::get('resource.lbLoginSignupFirstname')}}" id="stu_first_name_en"
            ...
            <div class="form-group">
                ...
                <div class="input-icon">
                    ...
                    <input class="form-control placeholder-no-fix"
                           onkeyup="return this.value = this.value.toUpperCase()" type="text"
                           placeholder="{{Lang::get('resource.lbLoginSignupLastname')}}" id="stu_last_name_en"
            ...
            <div class="form-group" style="border-bottom: 1px dotted #eee;padding-bottom:20px;">
                ...
                <div class="input-icon">
                    ...
                    <input class="form-control placeholder-no-fix" type="text"
                           placeholder="{{Lang::get('resource.lbLoginSignupTel')}}" id="stu_phone" name="stu_phone"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-icon">
                    <i class="fa fa-envelope"></i>
                    <input class="form-control placeholder-no-fix" type="text" pattern="[^ @]*@[^ @]*"
                           placeholder="{{Lang::get('resource.lbLoginEmail')}}" id="stud_email" name="stu_email"/></div>
            </div>
            <div class="form-group">
                ...
                <div class="input-icon">
                    <i class="fa fa-lock"></i>
                    <input class="form-control placeholder-no-fix" type="password" autocomplete="off"
                           id="register_password" placeholder="{{Lang::get('resource.lbLoginSignupPassword')}}"
                           id="stu_password" name="stu_password"/></div>
            </div>
            <div class="form-group">
                ...
                <div class="controls">
                    <div class="input-icon">
                        ...
                        <input class="form-control placeholder-no-fix" type="password" autocomplete="off"
                               placeholder="{{Lang::get('resource.lbLoginSignupPasswordReType')}}" id="rpassword"
                               name="rpassword"/></div>
                </div>
            </div>
            <div class="formm-group">
