    ...
    <form class="login-form" action="{{ url('/login')}}" method="post">    
        ...
        <h3 class="form-title">Login to your account     </h3>
            ...
            <span> Enter any e-mail and password.     </span>
                                    ...
                                    <label cl                                ass="control-label visible-ie8 visible-ie9">E-Mail</label>
                                    <div class="input-icon">
                                        <i                                             class="fa fa-envelope"></i>
                                            <input class="form-control placeholder-no-fix" pattern="[^ @]*@[^ @]*" type="text" autocomp                                                   lete="off" placeholder="E-Mail"
                                                            name="stu                                              _email"/></div>
                                            </div>
                                                           <div class="                                                  form-group">
                                            ...
                                            <input class="form-control placeholder-no-fix" type="p                                                   assword" autocomplete="off"
                                                                                      placeholde                                        r="Password" name="stu_password"/></                                            div>
                                </div>
                                <di                                        v class="form-a                                        ctions">

                                                                        <button type="submit" class="btn gre                                            en pull-right"> Login</button>
                                </div>
                                <div class="forget-password">
                                    <h4>Forgot your password ?</h4>
                                    <p                                    > no worries, click
                                <a href="javascript:;" id="forget-password"> her                            e </a> to reset                            your password. </p>
                                                </div>
                        <div class="create-account">
                            <p> Don't have                                 an account yet ?&nbsp;
                                <a href="javascript:;" id=                                "register-btn"> C                            reate an accoun                        t </a>
                                <                        /p>
                            </div>
                         </form>
    <!-- END LOGIN FORM -->
