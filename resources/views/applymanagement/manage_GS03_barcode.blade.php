...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span>ปรับปรุงการชำระเงินด้วยการแสกน Barcode</span>
        </li>
    </ul>
...
@section('pagetitle')
<h1 class="page-title">ปรับปรุงการชำระเงินด้วยการแสกน Barcode
