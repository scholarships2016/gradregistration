	...
	var fileInput = $(this)
		...
		.bind('change',function(){
			...
			uploadFeedback
				...
				.addClass('customfile-ext') //add file extension class
                                .addClass(fileExt) //add file extension class
				.data('fileExt', fileExt) //store file extension for class removal on next change
				.addClass('customfile-feedback-populated'); //add class to show populated state
			//change text of button	
//			uploadButton.val('เปลี่ยนไฟล์');
	...
	var uploadButton = $('<input type="button" class="exp-button customfile-button" name="btnBrowse" id="btnBrowse" value="เลือกไฟล์"/>').appendTo(upload);
